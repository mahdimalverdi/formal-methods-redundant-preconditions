...
% In RTL paragraphs, parentheses around LTR text can appear visually reversed.
% Wrap LTR parenthetical phrases with \lrpar{...} to keep parentheses direction.
\providecommand{\textLR}[1]{\beginL #1\endL}
\newcommand{\LRM}{\char"200E}
\newcommand{\lrpar}[1]{\LRM\textLR{(#1)}\LRM}
\newcommand{\lrcode}[1]{\LRM\textLR{\texttt{#1}}\LRM}
